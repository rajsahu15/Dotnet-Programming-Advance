...
Create Procedure empNameDetails
  @EMPLOYEE_ID INT
 AS
 BEGIN
    SELECT FIRST_NAME ,LAST_NAME,EMAIL,PHONE_NUMBER,SALARY,DEPARTMENT_ID 
	from EMP where EMPLOYEE_ID= @EMPLOYEE_ID;
   
 END;

 EXEC empNameDetails 101;